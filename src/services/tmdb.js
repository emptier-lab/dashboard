...
class TMDBService {
  ...
  // Get movie details
  async getMovieDetails(movieId, appendToResponse = 'credits,videos,similar,recommendations') {
    return this.makeRequest(`/movie/${movieId}`, { append_to_response: appendToResponse })
  }

  // Get TV show details
  async getTVDetails(tvId, appendToResponse = 'credits,videos,similar,recommendations') {
    return this.makeRequest(`/tv/${tvId}`, { append_to_response: appendToResponse })
  }

  // Get season details
  async getSeasonDetails(tvId, seasonNumber, appendToResponse = 'credits') {
    return this.makeRequest(`/tv/${tvId}/season/${seasonNumber}`, { append_to_response: appendToResponse })
  }

  // Get episode details
  async getEpisodeDetails(tvId, seasonNumber, episodeNumber, appendToResponse = 'credits') {
    return this.makeRequest(`/tv/${tvId}/season/${seasonNumber}/episode/${episodeNumber}`, { append_to_response: appendToResponse })
  }
  ...
  // Get person details
  async getPersonDetails(personId, appendToResponse = 'movie_credits,tv_credits') {
    return this.makeRequest(`/person/${personId}`, { append_to_response: appendToResponse })
  }
